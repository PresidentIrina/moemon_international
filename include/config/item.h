...
#define I_USE_EVO_HELD_ITEMS_FROM_BAG   TRUE        // If TRUE, items such as Razor Claw or Electirizer will be usable from the bag to evolve a Moémon just like in LA.
...
#define I_EXP_SHARE_FLAG        0           // If this flag is set, every Moémon in the party will gain experience, regardless if they participated in the battle or not.
