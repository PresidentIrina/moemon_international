...
#define B_WEATHER_SANDSTORM           (B_WEATHER_SANDSTORM_TEMPORARY | B_WEATHER_SANDSTORM_PERMANENT | B_WEATHER_SANDSTORM_PRIMAL)
...
#define B_WEATHER_HAIL                (B_WEATHER_HAIL_TEMPORARY | B_WEATHER_HAIL_PERMANENT | B_WEATHER_HAIL_PRIMAL)
...
#define B_WEATHER_PRIMAL_ANY          (B_WEATHER_RAIN_PRIMAL | B_WEATHER_SUN_PRIMAL | B_WEATHER_STRONG_WINDS | B_WEATHER_HAIL_PRIMAL | B_WEATHER_SNOW_PRIMAL | B_WEATHER_SANDSTORM_PRIMAL)
#define B_WEATHER_SNOW_TEMPORARY      (1 << 11)
#define B_WEATHER_SNOW_PERMANENT      (1 << 12)
#define B_WEATHER_SNOW                (B_WEATHER_SNOW_TEMPORARY | B_WEATHER_SNOW_PERMANENT | B_WEATHER_SNOW_PRIMAL)
#define B_WEATHER_HAIL_PRIMAL         (1 << 13)
#define B_WEATHER_SNOW_PRIMAL         (1 << 14)
#define B_WEATHER_SANDSTORM_PRIMAL    (1 << 15)
...
#define ENUM_WEATHER_HAIL_PRIMAL          9
#define ENUM_WEATHER_SNOW_PRIMAL          10
#define ENUM_WEATHER_SANDSTORM_PRIMAL     11
...
#define B_WIN_ACTION_MENU         2 // "Fight/Moémon/Bag/Run" menu
