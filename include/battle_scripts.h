...
extern const u8 BattleScript_FrozenSummitHailActivates[];
extern const u8 BattleScript_FrozenSummitSnowActivates[];
extern const u8 BattleScript_DesertStormActivates[];
