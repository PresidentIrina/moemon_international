...
SINGLE_BATTLE_TEST("Rivalry increases power by x1.25 towards Moémon of the same gender", s16 damage)
{
    u16 species, ability;
...
SINGLE_BATTLE_TEST("Rivalry decreases power by x0.75 towards Moémon of different gender", s16 damage)
{
