...
const u8 gText_Pokemon[] = _("Moémon");
...
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild Moémon will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild Moémon will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PokeBallsPocket[] = _("Moé Balls");
...
const u8 gText_PokemonJump[] = _("Moémon JUMP");
...
const u8 gText_PyramidPokemon[] = _("PYRAMID: Moémon");
...
const u8 gText_PokenavAndBag[] = _("MoéNav AND BAG");
const u8 gText_HeldItems[] = _("HELD ITEMS");
const u8 gText_PokemonOrder[] = _("Moémon ORDER");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this Moémon?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0}!");
const u8 gText_MarkYourPkmn[] = _("Mark your Moémon.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last Moémon!");
const u8 gText_YourPartysFull[] = _("Your party's full!{PAUSE_UNTIL_PRESS}");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a Moémon!");
...
const u8 gText_GiveToAPkmn[] = _("GIVE to a Moémon?");
...
const u8 gPCText_Pokecenter[] = _("MoéCenter");
...
const u8 gText_WithdrawPokemon[] = _("WITHDRAW Moémon");
const u8 gText_DepositPokemon[] = _("DEPOSIT Moémon");
const u8 gText_MovePokemon[] = _("MOVE Moémon");
const u8 gText_MoveItems[] = _("MOVE ITEMS");
const u8 gText_SeeYa[] = _("SEE YA!");
const u8 gText_WithdrawMonDescription[] = _("Move Moémon stored in BOXES to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store Moémon in your party in BOXES.");
const u8 gText_MoveMonDescription[] = _("Organize the Moémon in BOXES and\nin your party.");
const u8 gText_MoveItemsDescription[] = _("Move items held by any Moémon\nin a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("Return to the previous menu.");
const u8 gText_JustOnePkmn[] = _("There is just one Moémon with you.");
...
const u8 gText_CheckPokemonInDetail[] = _("Check Moémon in detail.");
...
const u8 gText_PutAwayPokenav[] = _("Put away the MoéNav.");
...
const u8 gText_CheckPartyPokemonInDetail[] = _("Check party Moémon in detail.");
const u8 gText_CheckAllPokemonInDetail[] = _("Check all Moémon in detail.");
const u8 gText_ReturnToPokenavMenu[] = _("Return to the MoéNav menu.");
const u8 gText_FindCoolPokemon[] = _("Find cool Moémon.");
const u8 gText_FindBeautifulPokemon[] = _("Find beautiful Moémon.");
const u8 gText_FindCutePokemon[] = _("Find cute Moémon.");
const u8 gText_FindSmartPokemon[] = _("Find smart Moémon.");
const u8 gText_FindToughPokemon[] = _("Find tough Moémon.");
...
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("TRAINER'S Moémon");
...
const u8 gText_MatchCallSteven_Pokemon[] = _("Ultimate STEEL Moémon.");
...
const u8 gText_MatchCallBrendan_Pokemon[] = _("I will use various Moémon.");
const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be a better Moémon");
...
const u8 gText_MatchCallMay_Pokemon[] = _("I'll use any Moémon!");
const u8 gText_MatchCallMay_Intro1[] = _("My Moémon and I help");
...
const u8 gText_ContinueMenuPokedex[] = _("Moédex");
...
const u8 gText_PokemonOnHook[] = _("A Moémon's on the hook!{PAUSE_UNTIL_PRESS}");
...
const u8 gEasyChatGroupName_Pokemon[] = _("Moémon");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("Moémon2");
