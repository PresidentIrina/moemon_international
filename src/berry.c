...
static const u8 sBerryDescriptionPart2_Wiki[] = _("to help Moémon grip it.");
...
static const u8 sBerryDescriptionPart2_Tanga[] = _("Bug Moémon with its stringy petals.");
...
static const u8 sBerryDescriptionPart2_Colbur[] = _("Moémon to reach far-off places.");
