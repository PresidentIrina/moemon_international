...
const u8 gGiftRibbonDescriptionPart1_PokemonBattleCup[] = _("Moémon BATTLE CUP");
const u8 gGiftRibbonDescriptionPart2_Participation[] = _("Participation RIBBON");
const u8 gGiftRibbonDescriptionPart1_PokemonLeague[] = _("Moémon League");
const u8 gGiftRibbonDescriptionPart1_AdvanceCup[] = _("ADVANCE CUP");
const u8 gGiftRibbonDescriptionPart1_PokemonTournament[] = _("Moémon Tournament");
const u8 gGiftRibbonDescriptionPart2_Participation2[] = _("Participation RIBBON");
const u8 gGiftRibbonDescriptionPart1_PokemonEvent[] = _("Moémon Event");
const u8 gGiftRibbonDescriptionPart1_PokemonFestival[] = _("Moémon Festival");
...
const u8 gGiftRibbonDescriptionPart1_PokemonCenterTokyo[] = _("Moémon Center TOKYO");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterOsaka[] = _("Moémon Center OSAKA");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNagoya[] = _("Moémon Center NAGOYA");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNY[] = _("Moémon Center NY");
...
const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("for a loved Moémon.");
const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("RIBBON that shows");
const u8 gGiftRibbonDescriptionPart2_LoveForPokemon[] = _("love for Moémon.");
