const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_POKEMANIAC] = _("MoéManiac"),
    ...
    [TRAINER_CLASS_POKEFAN] = _("MoéFan"),
    ...
    [TRAINER_CLASS_MAGMA_ADMIN_F] = _("MAGMA ADMIN"),
    ...
    [TRAINER_CLASS_ROCKET_GRUNT_M] = _("RKT GRUNT"),
    [TRAINER_CLASS_ROCKET_GRUNT_F] = _("RKT GRUNT"),
    [TRAINER_CLASS_ROCKET_ADMIN_1] = _("RKT ADMIN"),
    [TRAINER_CLASS_ROCKET_ADMIN_2] = _("RKT ADMIN"),
    [TRAINER_CLASS_ROCKET_LEADER] = _("RKT LEADER"),
    [TRAINER_CLASS_GALACTIC_GRUNT_M] = _("GLCTC GRUNT"),
    [TRAINER_CLASS_GALACTIC_GRUNT_F] = _("GLCTC GRUNT"),
    [TRAINER_CLASS_GALACTIC_ADMIN_1] = _("GLCTC ADMIN"),
    [TRAINER_CLASS_GALACTIC_ADMIN_2] = _("GLCTC ADMIN"),
    [TRAINER_CLASS_GALACTIC_ADMIN_3] = _("GLCTC ADMIN"),
    [TRAINER_CLASS_GALACTIC_LEADER] = _("GLCTC LEADER"),
};
