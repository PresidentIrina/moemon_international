...
#define GRENINJA_MISC_INFO                              \
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .weight = 17,
        .description = COMPOUND_STRING(
            "This amiable Moémon is easy to train.\n"
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "any bewildered Moémon that pop out of\n"
            "the grass."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
    ...
    [SPECIES_SCATTERBUG] =
    {
        ...
        .weight = 25,
        .description = COMPOUND_STRING(
            "When under attack from bird Moémon,\n"
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "These hot-blooded Moémon are quick\n"
            "to start a fight."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
    ...
    [SPECIES_FLABEBE_RED_FLOWER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Immediately after birth, this Moémon\n"
    ...
    [SPECIES_FLABEBE_ORANGE_FLOWER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "return. This Moémon likes orange\n"
            "flowers best of all."),
    },
    [SPECIES_FLABEBE_BLUE_FLOWER]   =
    {
        ...
        .description = COMPOUND_STRING(
            "This Moémon likes blue flowers\n"
...
#define FLOETTE_NORMAL_INFO(form, FORM, iconPal)                                                \
    ...
    [SPECIES_FLOETTE_RED_FLOWER] =
    {
        ...
        .description = COMPOUND_STRING(
            "This Moémon uses red wavelengths\n"
    ...
    [SPECIES_FLOETTE_YELLOW_FLOWER] =
    {
        ...
        .description = COMPOUND_STRING(
            "This Moémon can draw forth the\n"
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_FLORGES_YELLOW_FLOWER] =
    {
        ...
        .description = COMPOUND_STRING(
            "This Moémon battles by drawing\n"
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_AEGISLASH_BLADE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Moémon eventually drained him of\n"
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .weight = 252,
        .description = COMPOUND_STRING(
            "This ancient Moémon was restored from\n"
...
#define SLIGGOO_MISC_INFO                                       \
    ...
    [SPECIES_SLIGGOO] =
    {
        ...
        .weight = 175,
        .description = COMPOUND_STRING(
            "This Moémon's mucous can dissolve\n"
...
#if P_UPDATED_EGG_GROUPS >= GEN_8
    #define BERGMITE_EGG_GROUPS {EGG_GROUP_HUMAN_LIKE, EGG_GROUP_MINERAL }
#else
    #define BERGMITE_EGG_GROUPS {EGG_GROUP_HUMAN_LIKE, EGG_GROUP_MONSTER }
#endif
...
,
    ...
    [SPECIES_AVALUGG_HISUIAN] =
    {
        ...
        .natDexNum = NATIONAL_DEX_AVALUGG_HISUIAN,
        .height = 14,
        .weight = 2624,
        .description = COMPOUND_STRING(
...
#define DIANCE_MISC_INFO                                                                \
    ...
    [SPECIES_DIANCIE] =
    {
        ...
        PALETTES(Diancie),
        ICON(Diancie, 1),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SHINY_STONE, SPECIES_DIANCIE_MEGA}),
    },
