...
#include "config/pokemon.h"
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .description = COMPOUND_STRING(
            "She carries a large collection of seeds\n"
            "for planting, but she ends up eating\n"
            "most of them.\n"
            ""),
        .pokemonScale = 356,
        .pokemonOffset = 17,
    ...
    [SPECIES_IVYSAUR] =
    {
        ...
        .weight = 130,
        .description = COMPOUND_STRING(
            "Ivysaur likes to act tough, but\n"
            "she's actually quite sweet and\n"
            "caring deep down. She helps run a daycare\n"
            "for Grass-type Moémon."),
        .pokemonScale = 335,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define VENUSAUR_MISC_INFO                                                              \
    ...
    [SPECIES_VENUSAUR] =
    {
        ...
        .weight = 1000,
        .description = COMPOUND_STRING(
            "Venusaur's motherly attitude makes quite\n"
            "the contrast with how she acted in\n"
            "the past. Her grove is a safe haven for\n"
            "young Moémon."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 388,
    ...
    [SPECIES_VENUSAUR_MEGA] =
    {
        ...
        .weight = 1555,
        .description = COMPOUND_STRING(
            "After Mega Evolution, Venusaur is able\n"
            "to use her flower to spread spores that\n"
            "calm those around her"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 388,
        .trainerOffset = 6,
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_NONE, ABILITY_SOLAR_POWER },
        ...
        .weight = 85,
        .description = COMPOUND_STRING(
            "Were her flame to go out, she would\n"
            "weaken greatly. She won't attack unless\n"
            "provoked.\n"
            ""),
        .pokemonScale = 444,
        .pokemonOffset = 18,
    ...
    [SPECIES_CHARMELEON] =
    {
        ...
        .weight = 190,
        .description = COMPOUND_STRING(
            "Her flame becomes more intense\n"
            "depending on her temperament.\n"
            "When Charmeleon's temper gets the best\n"
            "of her, she tends to lash out."),
        .pokemonScale = 302,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define CHARIZARD_MISC_INFO                                                             \
    ...
    [SPECIES_CHARIZARD] =
    {
        ...
        .weight = 905,
        .description = COMPOUND_STRING(
            "With her newly grown wings, she soars\n"
            "through the sky to search for treasure.\n"
            "She's a treasure hunter's greatest\n"
            "companion."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 302,
        ...
        PALETTES(Charizard),
        ICON(Charizard, 0),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_FIRE_STONE, SPECIES_CHARIZARD_MEGA_X},
                                {EVO_ITEM, ITEM_SUN_STONE, SPECIES_CHARIZARD_MEGA_Y}),
    },
    ...
    [SPECIES_CHARIZARD_MEGA_X] =
    {
        ...
        .weight = 1105,
        .description = COMPOUND_STRING(
            "The overwhelming power that fills her\n"
            "entire body causes her flames to turn\n"
            "blue. She thinks black looks better\n"
            "with her new flames rather than red."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 302,
        .trainerOffset = 3,
    ...
    [SPECIES_CHARIZARD_MEGA_Y] =
    {
        ...
        .weight = 1005,
        .description = COMPOUND_STRING(
            "Her bond with her Trainer is the source\n"
            "of her power. She boasts speed and\n"
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_NONE, ABILITY_RAIN_DISH },
        ...
        .weight = 90,
        .description = COMPOUND_STRING(
            "Squirtle is always blowing bubbles.\n"
            "She keeps practicing, dreaming of the\n"
            "day she is able to spout enormous\n"
            "geysers."),
        .pokemonScale = 412,
        .pokemonOffset = 18,
        .trainerScale = 256,
    ...
    [SPECIES_WARTORTLE] =
    {
        ...
        .weight = 225,
        .description = COMPOUND_STRING(
            "Wartortle's tail has the consistency of\n"
            "seafoam. Farmers believe that touching\n"
            "it ends droughts.\n"
            ""),
        .pokemonScale = 332,
        .pokemonOffset = 10,
...
#define BLASTOISE_MISC_INFO                                                             \
    ...
    [SPECIES_BLASTOISE] =
    {
        ...
        .weight = 855,
        .description = COMPOUND_STRING(
            "This powerful Moémon carries two large\n"
            "cannons that pressurize her water\n"
            "to give it more force. At full power, her\n"
            "water can bore through a mountain."),
        .pokemonScale = 256,
        .pokemonOffset = -1,
        .trainerScale = 293,
        .trainerOffset = 2,
    ...
    [SPECIES_BLASTOISE_MEGA] =
    {
        ...
        .weight = 1011,
        .description = COMPOUND_STRING(
            "Her improved cannon is as powerful\n"
            "as a tank's. Her tough legs and back\n"
            "enable her to withstand the recoil from\n"
            "firing the cannon."),
        .pokemonScale = 256,
        .pokemonOffset = -1,
        .trainerScale = 293,
    ...
    [SPECIES_CATERPIE] =
    {
        ...
        .weight = 29,
        .description = COMPOUND_STRING(
            "A young child with dreams of one day\n"
            "learning to fly. She's afraid of\n"
            "everything, but her friend Weedle\n"
    ...
    [SPECIES_METAPOD] =
    {
        ...
        .weight = 99,
        .description = COMPOUND_STRING(
            "Metapod believes the key to\n"
            "achieving her dreams of flight is tons\n"
            "of rest.\n"
            ""),
        .pokemonScale = 350,
        .pokemonOffset = 18,
...
#define BUTTERFREE_MISC_INFO                                                        \
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        .weight = 320,
        .description = COMPOUND_STRING(
            "Butterfree's patience finally paid\n"
            "off, and she was rewarded with\n"
            "flight and beauty. The dust from her\n"
            "wings has many strange properties."),
        .pokemonScale = 312,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WEEDLE] =
    {
        ...
        .weight = 32,
        .description = COMPOUND_STRING(
            "Weedle wants to grow strong enough to\n"
            "protect Caterpie, her best friend. She\n"
            "can pass venom through the tip of her\n"
            "hair to ward off Flying-type Moémon."),
        .pokemonScale = 455,
        .pokemonOffset = 22,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KAKUNA] =
    {
        ...
        .weight = 100,
        .description = COMPOUND_STRING(
            "Kakuna believes the best offense is\n"
            "a good defense. By remaining still, she\n"
            "acts as a shield for groups of Caterpie.\n"
            ""),
        .pokemonScale = 424,
        .pokemonOffset = 17,
        .trainerScale = 256,
...
#define BEEDRILL_MISC_INFO                                      \
    ...
    [SPECIES_BEEDRILL] =
    {
        ...
        .weight = 295,
        .description = COMPOUND_STRING(
            "Beedrill leaps to defend groups of\n"
            "Butterfree from harm, but doesn't seem to\n"
            "realize that her help is unneeded.\n"
            ""),
        .pokemonScale = 366,
        .pokemonOffset = 2,
        .trainerScale = 256,
        ...
        PALETTES(Beedrill),
        ICON(Beedrill, 2),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SILVER_POWDER, SPECIES_BEEDRILL_MEGA}),
    },
    ...
    [SPECIES_BEEDRILL_MEGA] =
    {
        ...
        .weight = 405,
        .description = COMPOUND_STRING(
            "Butterfree may not need Beedrill's help,\n"
            "but that doesn't mean others don't.\n"
            "She has trained to become even faster\n"
            "to help Moemon in need."),
        .pokemonScale = 366,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PIDGEY] =
    {
        ...
        .weight = 18,
        .description = COMPOUND_STRING(
            "Pidgey tends to fly in flocks. She enjoys\n"
            "bringing people items just to\n"
    ...
    [SPECIES_PIDGEOTTO] =
    {
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "She enjoys racing with other Moémon\n"
            "for sport. Her vision is impeccable, and\n"
            "she can spot food from a mile away.\n"
            ""),
        .pokemonScale = 331,
        .pokemonOffset = 10,
        .trainerScale = 256,
...
#define PIDGEOT_MISC_INFO                                                           \
    ...
    [SPECIES_PIDGEOT] =
    {
        ...
        .weight = 395,
        .description = COMPOUND_STRING(
            "Years of racing have toned her wings. She\n"
            "has great pride in her speed, and she's\n"
            "been recorded breaking Mach 2.\n"
            ""),
        .pokemonScale = 269,
        .pokemonOffset = 0,
        .trainerScale = 256,
        ...
        PALETTES(Pidgeot),
        ICON(Pidgeot, 0),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SHARP_BEAK, SPECIES_PIDGEOT_MEGA}),
    },
    ...
    [SPECIES_PIDGEOT_MEGA] =
    {
        ...
        .weight = 505,
        .description = COMPOUND_STRING(
            "With her muscular stamina now greatly\n"
            "increased, she can fly continuously\n"
...
#define RATICATE_MISC_INFO                  \
    ...
    [SPECIES_RATTATA] =
    {
        ...
        .weight = 35,
        .description = COMPOUND_STRING(
            "Many people find her annoying due\n"
            "to her very high-pitched voice and\n"
            "tendency to chew clothing.\n"
            ""),
        .pokemonScale = 481,
        .pokemonOffset = 21,
        .trainerScale = 256,
    ...
    [SPECIES_RATICATE] =
    {
        ...
        .weight = 185,
        .description = COMPOUND_STRING(
            "She can modify clothes with her teeth\n"
            "skillfully. It's probably better to wash\n"
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .weight = 20,
        .description = COMPOUND_STRING(
            "While inept at flying high due to her\n"
            "small wings, she agressively defends\n"
            "her territory and friends.\n"
            ""),
        .pokemonScale = 571,
        .pokemonOffset = 22,
        .trainerScale = 256,
    ...
    [SPECIES_FEAROW] =
    {
        ...
        .weight = 380,
        .description = COMPOUND_STRING(
            "Donning new magnificent wings, Fearow\n"
            "can fly all day without rest, much to\n"
            "Pidgeotto's excitement.\n"
            ""),
        .pokemonScale = 278,
        .pokemonOffset = 1,
        .trainerScale = 256,
    ...
    [SPECIES_EKANS] =
    {
        ...
        .weight = 69,
        .description = COMPOUND_STRING(
            "Travelers say that Ekans uses her\n"
            "charm and looks to lure in Trainers,\n"
            "but she is more likely to coil up and\n"
    ...
    [SPECIES_ARBOK] =
    {
        ...
        .weight = 650,
        .description = COMPOUND_STRING(
            "Arbok coils around her prey, slowly\n"
            "choking the life out of them. She seems\n"
            "to take pleasure in their fear.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 296,
...
#define RAICHU_MISC_INFO                                        \
    ...
    [SPECIES_RAICHU] =
    {
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "When Raichu can't let out her built up\n"
            "electric energy, she becomes very\n"
    ...
    [SPECIES_RAICHU_ALOLAN] =
    {
        ...
        .weight = 210,
        .description = COMPOUND_STRING(
            "She uses psychokinesis to control\n"
            "electricity. She focuses psychic energy\n"
            "into her tail and rides it like she's surfing.\n"
            "Another name for this Moémon is 'hodad'."),
        .pokemonScale = 426,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define SANDSLASH_MISC_INFO                                 \
    ...
    [SPECIES_SANDSHREW] =
    {
        ...
        .weight = 120,
        .description = COMPOUND_STRING(
            "Sandshrew likes to bury herself in sand.\n"
            "When scared, she is known to curl up\n"
            "into a ball. Groups of Sandshrew\n"
            "participate in downhill dune races."),
        .pokemonScale = 365,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SANDSLASH] =
    {
        ...
        .weight = 295,
        .description = COMPOUND_STRING(
            "Sandslash's sharp nails make her a force\n"
            "to be reckoned with. Her spiky hair\n"
            "is difficult for Trainers to style.\n"
            ""),
        .pokemonScale = 341,
        .pokemonOffset = 11,
        .trainerScale = 256,
    ...
    [SPECIES_SANDSHREW_ALOLAN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "has granted this Moémon a body of ice\n"
            "that's as hard as steel.\n"
            "Predators go after her soft belly."),
        .pokemonScale = 365,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SANDSLASH_ALOLAN] =
    {
        ...
        .weight = 550,
        .description = COMPOUND_STRING(
            "She uses large, hooked claws to cut a path\n"
            "through deep snow as she runs.\n"
            "On snowy mountains, Sandslash\n"
            "is faster than any other Moémon."),
        .pokemonScale = 341,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_NIDORAN_F] =
    {
        ...
        .weight = 70,
        .description = COMPOUND_STRING(
            "She gets embarassed when perceived as\n"
            "girly, so she'll spend most of her time\n"
            "playing swords with NidoranM.\n"
            ""),
        .pokemonScale = 488,
        .pokemonOffset = 21,
        .trainerScale = 256,
    ...
    [SPECIES_NIDORINA] =
    {
        ...
        .weight = 200,
        .description = COMPOUND_STRING(
            "She's grown up, but remains a tomboy.\n"
            "She gets ornery when Trainers call\n"
            "her cute and doesn't get along well\n"
            "with other girls."),
        .pokemonScale = 381,
        .pokemonOffset = 15,
        .trainerScale = 256,
    ...
    [SPECIES_NIDOQUEEN] =
    {
        ...
        .weight = 600,
        .description = COMPOUND_STRING(
            "She serves as the mother to the Nidoran.\n"
            "She's aware of Nidoking's feelings, but\n"
            "doesn't reciprocate them.\n"
            ""),
        .pokemonScale = 293,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_NIDORAN_M] =
    {
        ...
        .weight = 90,
        .description = COMPOUND_STRING(
            "He is known for playing very rough.\n"
            "Without knowing why, he likes being\n"
            "around NidoranF best.\n"
            ""),
        .pokemonScale = 511,
        .pokemonOffset = 20,
        .trainerScale = 256,
    ...
    [SPECIES_NIDORINO] =
    {
        ...
        .weight = 195,
        .description = COMPOUND_STRING(
            "Nidorino is calmer than he appears\n"
            "but shows off when around\n"
            "his friend Nidorina.\n"
            ""),
        .pokemonScale = 408,
        .pokemonOffset = 15,
    ...
    [SPECIES_NIDOKING] =
    {
        ...
        .weight = 620,
        .description = COMPOUND_STRING(
            "Nidoking has honed his strength in order\n"
            "to protect his family. He's intimidating,\n"
            "but has a soft spot for Nidoqueen.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_CLEFFA] =
    {
        ...
        .weight = 30,
        .description = COMPOUND_STRING(
            "Cleffa loves stars, space, and Moon\n"
            "Stones. Unsurprisingly, her favourite\n"
            "Moémon is Minior.\n"
            ""),
        .pokemonScale = 462,
        .pokemonOffset = 23,
    ...
    [SPECIES_CLEFAIRY] =
    {
        ...
        .weight = 75,
        .description = COMPOUND_STRING(
            "She dedicates herself to her study of\n"
            "everything outer space. She dreams of\n"
            "someday travelling to distant stars.\n"
            ""),
        .pokemonScale = 441,
        .pokemonOffset = 20,
        .trainerScale = 256,
    ...
    [SPECIES_CLEFABLE] =
    {
        ...
        .weight = 400,
        .description = COMPOUND_STRING(
            "Clefable spends hours each day attempting\n"
            "to build vehicles capable of bringing\n"
            "her to the moon. She hosts odd rituals\n"
            "during full moons."),
        .pokemonScale = 256,
        .pokemonOffset = 5,
        .trainerScale = 256,
...
#define NINETALES_MISC_INFO                                 \
    ...
    [SPECIES_VULPIX] =
    {
        ...
        .description = COMPOUND_STRING(
            "Vulpix is obsessed with being tidy. It is\n"
            "said that spirits tend towards homes\n"
            "cleaned by her.\n"
            ""),
    ...
    [SPECIES_NINETALES] =
    {
        ...
        .description = COMPOUND_STRING(
            "Trainers that cross Ninetales claim to\n"
            "be cursed, but others claim that a\n"
            "loyal Ninetales can ward off bad spirits.\n"
            ""),
    ...
    [SPECIES_VULPIX_ALOLAN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "one another. In hot weather, this Moémon\n"
            "makes ice shards with its six tails and\n"
            "sprays them around to cool herself off."),
    ...
    [SPECIES_NINETALES_ALOLAN] =
    {
        ...
        .description = COMPOUND_STRING(
            "While she will guide travelers who get lost\n"
            "on a snowy mountain down to the\n"
            "mountain's base, she won't forgive anyone\n"
            "who harms nature."),
    ...
    [SPECIES_IGGLYBUFF] =
    {
        ...
        .weight = 10,
        .description = COMPOUND_STRING(
            "Igglybuff loves singing, but she can't\n"
            "hit high notes. Her attempts often leave\n"
            "her with a sore throat.\n"
            ""),
        .pokemonScale = 457,
        .pokemonOffset = -1,
        .trainerScale = 256,
    ...
    [SPECIES_JIGGLYPUFF] =
    {
        ...
        .weight = 55,
        .description = COMPOUND_STRING(
            "A Moémon with dreams of becoming a\n"
            "pop idol. Her songs are cutesy and\n"
            "very catchy.\n"
            ""),
        .pokemonScale = 433,
        .pokemonOffset = 2,
    ...
    [SPECIES_WIGGLYTUFF] =
    {
        ...
        .weight = 120,
        .description = COMPOUND_STRING(
            "Wigglytuff is the most popular singer in\n"
            "Kanto. Trainers come from as far as\n"
            "Unova to see her perform.\n"
            ""),
        .pokemonScale = 328,
        .pokemonOffset = 11,
        .trainerScale = 256,
    ...
    [SPECIES_ZUBAT] =
    {
        ...
        .weight = 75,
        .description = COMPOUND_STRING(
            "Zubat's shyness leads her to hide in\n"
            "caves to avoid interaction. Her eyes\n"
            "have weakened from constant darkness,\n"
            "so she instead navigates by sound."),
        .pokemonScale = 362,
        .pokemonOffset = -5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GOLBAT] =
    {
        ...
        .weight = 550,
        .description = COMPOUND_STRING(
            "Having grown out of her asocial attitude,\n"
            "Golbat is consntantly seeking attention.\n"
            "Her screeches keep Trainers up at night.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 256,
    ...
    [SPECIES_CROBAT] =
    {
        ...
        .weight = 750,
        .description = COMPOUND_STRING(
            "Crobat's strong wings mean she rarely has\n"
            "to land. Due to this, she trips often\n"
            "when forced to walk.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
    ...
    [SPECIES_ODDISH] =
    {
        ...
        .weight = 54,
        .description = COMPOUND_STRING(
            "This childish Moémon likes to play\n"
            "pranks on travelers by jumping out\n"
            "of tall grass.\n"
            ""),
        .pokemonScale = 423,
        .pokemonOffset = 19,
    ...
    [SPECIES_GLOOM] =
    {
        ...
        .weight = 86,
        .description = COMPOUND_STRING(
            "Gloom is a very absent-minded Moémon who\n"
            "tends to drool when lost in thought.\n"
            "Munchlax are drawn to her honey-sweet\n"
            "aroma."),
        .pokemonScale = 329,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    [SPECIES_VILEPLUME] =
    {
        ...
        .weight = 186,
        .description = COMPOUND_STRING(
            "Vileplume is an enemy to those with\n"
            "allergies. One twirl of her umbrella can\n"
            "spread pollen for miles.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_BELLOSSOM] =
    {
        ...
        .weight = 58,
        .description = COMPOUND_STRING(
            "It is said that Bellossom's dance has the\n"
            "power to summon the sun when she\n"
            "gives it her all.\n"
            ""),
        .pokemonScale = 472,
        .pokemonOffset = 21,
    ...
    [SPECIES_PARAS] =
    {
        ...
        .weight = 54,
        .description = COMPOUND_STRING(
            "She has a hobby of creating various\n"
            "mushroom-based dishes. She can always\n"
            "be found in forests scrounging for\n"
            "ingredients."),
        .pokemonScale = 593,
        .pokemonOffset = 22,
        .trainerScale = 256,
    ...
    [SPECIES_PARASECT] =
    {
        ...
        .weight = 295,
        .description = COMPOUND_STRING(
            "If given a chance, she'll talk for hours\n"
            "about the many types of fungi she comes\n"
            "across. She uses them for various\n"
    ...
    [SPECIES_VENONAT] =
    {
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "A nocturnal Moémon. Her unkempt hair is\n"
            "known to cause sickness. She often stays\n"
            "up late finding bugs for her collection.\n"
            ""),
        .pokemonScale = 360,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_VENOMOTH] =
    {
        ...
        .weight = 125,
        .description = COMPOUND_STRING(
            "A maiden of the forest. She's found\n"
            "mostly at dusk and can create\n"
            "poisonous winds with a single flap of\n"
            "her wings."),
        .pokemonScale = 285,
        .pokemonOffset = 2,
        .trainerScale = 256,
...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 100 : 80)
    ...
    [SPECIES_DIGLETT] =
    {
        ...
        .weight = 8,
        .description = COMPOUND_STRING(
            "She struggles with her shyness toward\n"
            "other Moémon, but opens up around\n"
            "other Diglett.\n"
            ""),
    ...
    [SPECIES_DUGTRIO] =
    {
        ...
        .weight = 333,
        .description = COMPOUND_STRING(
            "Dugtrio's puppets are actually used\n"
            "to teach and organize Diglett for large\n"
            "digging operations.\n"
            ""),
...
#define PERSIAN_MISC_INFO                                       \
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .weight = 42,
        .description = COMPOUND_STRING(
            "Shops leave out treats to attract Meowth\n"
            "hoping she will bring in customers.\n"
            "Rumor has it that she brings good luck.\n"
            ""),
        .pokemonScale = 480,
        .pokemonOffset = 19,
        .trainerScale = 256,
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .weight = 320,
        .description = COMPOUND_STRING(
            "Her cat-like reflexes are quite adapted\n"
            "for high-speed battles, although she\n"
            "would rather nap in the sun.\n"
            ""),
        .pokemonScale = 320,
        .pokemonOffset = 10,
        .trainerScale = 256,
    ...
    [SPECIES_PERRSERKER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "actually hardened hair. This Moémon\n"
    ...
    [SPECIES_PSYDUCK] =
    {
        ...
        .weight = 196,
        .description = COMPOUND_STRING(
            "A Moémon with frightening psychic\n"
            "abilities. However, she can never\n"
    ...
    [SPECIES_GOLDUCK] =
    {
        ...
        .weight = 766,
        .description = COMPOUND_STRING(
            "She's normally found in rainy areas.\n"
            "Few Moémon can keep up with her\n"
    ...
    [SPECIES_MANKEY] =
    {
        ...
        .weight = 280,
        .description = COMPOUND_STRING(
            "Mankey's tomboyish attitude causes\n"
            "her to frequently pick fights.\n"
            "She's still working on her anger issues.\n"
            ""),
        .pokemonScale = 404,
        .pokemonOffset = 19,
        .trainerScale = 256,
    ...
    [SPECIES_PRIMEAPE] =
    {
        ...
        .weight = 320,
        .description = COMPOUND_STRING(
            "Primeape seeks arguments just to stave\n"
            "off boredom. Once an argument has\n"
            "started her stubbornness won't allow her\n"
            "to back out."),
        .pokemonScale = 326,
        .pokemonOffset = 10,
        .trainerScale = 256,
    ...
    [SPECIES_ANNIHILAPE] =
    {
        ...
        .weight = 560,
        .description = COMPOUND_STRING(
            "When her anger rose beyond a\n"
            "critical point, Annihilape gained power\n"
...
#define ARCANINE_MISC_INFO                                  \
    ...
    [SPECIES_GROWLITHE] =
    {
        ...
        .weight = 190,
        .description = COMPOUND_STRING(
            "Growlithe is very loyal to her\n"
            "Trainer. She'll follow any command\n"
    ...
    [SPECIES_ARCANINE] =
    {
        ...
        .weight = 1550,
        .description = COMPOUND_STRING(
            "Arcanine's beauty and vitality is\n"
            "recognized as legendary, even if she\n"
            "is far too humble to admit it.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 312,
    ...
    [SPECIES_POLIWAG] =
    {
        ...
        .weight = 124,
        .description = COMPOUND_STRING(
            "She struggles with walking and\n"
            "falls down often. While she may seem\n"
            "clumsy, she swims like a pro.\n"
            ""),
        .pokemonScale = 369,
        .pokemonOffset = 20,
        .trainerScale = 256,
    ...
    [SPECIES_POLIWHIRL] =
    {
        ...
        .weight = 200,
        .description = COMPOUND_STRING(
            "While she has finally mastered walking,\n"
            "Poliwhirl still prefers to spend her days\n"
    ...
    [SPECIES_POLIWRATH] =
    {
        ...
        .weight = 540,
        .description = COMPOUND_STRING(
            "Swimming has made this Moémon\n"
            "absurdly powerful. She can out-swim\n"
            "Trainers at even an Olympic level.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 256,
    ...
    [SPECIES_POLITOED] =
    {
        ...
        .weight = 339,
        .description = COMPOUND_STRING(
            "The strange singing of Politoed draws in\n"
            "crowds of Poliwag and Poliwhirl. She\n"
            "wears her hat like a crown.\n"
            ""),
        .pokemonScale = 289,
        .pokemonOffset = 6,
        .trainerScale = 256,
    ...
    [SPECIES_ABRA] =
    {
        ...
        .weight = 195,
        .description = COMPOUND_STRING(
            "Although young, her intelligence rivals\n"
            "that of human scholars. She sleeps 20\n"
            "hours a day to help preserve brain power.\n"
            ""),
        .pokemonScale = 363,
        .pokemonOffset = 14,
        .trainerScale = 256,
    ...
    [SPECIES_KADABRA] =
    {
        ...
        .weight = 565,
        .description = COMPOUND_STRING(
            "Training her brain constantly, Kadabra\n"
            "is learning to increase her powers via\n"
            "channeling them through objects.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 256,
...
#define ALAKAZAM_MISC_INFO                                          \
    ...
    [SPECIES_ALAKAZAM] =
    {
        ...
        .weight = 480,
        .description = COMPOUND_STRING(
            "Alakazam is known as the smartest\n"
            "of all Moémon. She can solve complex\n"
            "equations faster than a supercomputer.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 256,
        ...
        PALETTES(Alakazam),
        ICON(Alakazam, 2),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_TWISTED_SPOON, SPECIES_ALAKAZAM_MEGA}),
    },
    ...
    [SPECIES_ALAKAZAM_MEGA] =
    {
        ...
        .weight = 480,
        .description = COMPOUND_STRING(
            "Having trained her mind fully, Alakazam's\n"
            "true power has been unleashed. With her\n"
            "psychic powers, she can foresee all things."),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MACHOP] =
    {
        ...
        .weight = 195,
        .description = COMPOUND_STRING(
            "Machop studied mixed martial arts at\n"
            "an early age. In spite of her size, she\n"
            "outlifts professional bodybuilders.\n"
            ""),
        .pokemonScale = 342,
        .pokemonOffset = 14,
        .trainerScale = 256,
    ...
    [SPECIES_MACHOKE] =
    {
        ...
        .weight = 705,
        .description = COMPOUND_STRING(
            "Machoke seems arrogant because of\n"
            "her pride but only uses her strength to\n"
...
#define MACHAMP_MISC_INFO                                                   \
    ...
    [SPECIES_MACHAMP] =
    {
        ...
        .weight = 1300,
        .description = COMPOUND_STRING(
            "She often holds contests of strength for\n"
            "others. She is accused of being prideful,\n"
            "but just wants to be an inspiration to\n"
            "young Moémon who look up to her."),
        .pokemonScale = 280,
        .pokemonOffset = 1,
        .trainerScale = 269,
        .trainerOffset = -1,
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .weight = 40,
        .description = COMPOUND_STRING(
            "Bellsprout loves to chase people down\n"
            "and wrap them in hugs. Her sweet smell\n"
            "makes it hard to be mad at her for it.\n"
            ""),
        .pokemonScale = 354,
        .pokemonOffset = 16,
        .trainerScale = 256,
    ...
    [SPECIES_WEEPINBELL] =
    {
        ...
        .weight = 64,
        .description = COMPOUND_STRING(
            "Trainers that come near her are often\n"
            "assaulted with kisses. Perfume stores\n"
            "attempt to imitate her distinct scent.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_VICTREEBEL] =
    {
        ...
        .weight = 155,
        .description = COMPOUND_STRING(
            "She uses her charming appearances to\n"
            "lure victims in. Once in her embrace, it\n"
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .weight = 455,
        .description = COMPOUND_STRING(
            "Tentacool likes to hang out near beaches.\n"
            "Careless swimmers often get stung by\n"
            "her hair, giving them painful rashes.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_TENTACRUEL},
                                {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_TENTACRUEL_AQUA}),
    },
...
#define GOLEM_MISC_INFO                                 \
    ...
    [SPECIES_GEODUDE] =
    {
        ...
        .weight = 200,
        .description = COMPOUND_STRING(
            "Geodude takes her anger out on rocks.\n"
            "The resulting gravel is often used in\n"
    ...
    [SPECIES_GRAVELER] =
    {
        ...
        .weight = 1050,
        .description = COMPOUND_STRING(
            "She tends to get physical. If she hates\n"
            "you, she will hit you. If she likes you,\n"
            "she will hit you even harder.\n"
            ""),
    ...
    [SPECIES_GOLEM] =
    {
        ...
        .weight = 3000,
        .description = COMPOUND_STRING(
            "She poses on her rock as if she were a\n"
            "model. People mistake her for a statue\n"
            "which gives her mixed feelings.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 296,
...
#define RAPIDASH_MISC_INFO                                  \
    ...
    [SPECIES_PONYTA] =
    {
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "Her skin is warm to the touch, and she\n"
            "enjoys being groomed. When she runs,\n"
            "grass bursts into flames.\n"
            ""),
        .pokemonScale = 283,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_RAPIDASH] =
    {
        ...
        .weight = 950,
        .description = COMPOUND_STRING(
            "She has the strongest legs of any Moémon.\n"
            "A trail of fire follows everywhere\n"
            "that she runs.\n"
            ""),
...
#define GALARIAN_PONYTA_FAMILY_INFO                                                 \
    ...
    [SPECIES_PONYTA_GALARIAN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "This Moémon will look into your eyes and\n"
    ...
    [SPECIES_RAPIDASH_GALARIAN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Unleashed from this Moémon's horn,\n"
...
#define SLOWKING_MISC_INFO                                      \
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Many mistake her for being shrewd,\n"
            "but she rarely thinks about things other\n"
            "than fishing and relaxing.\n"
            ""),
    ...
    [SPECIES_SLOWBRO] =
    {
        ...
        .weight = 785,
        .description = COMPOUND_STRING(
            "The backpack is a gift from Shellder.\n"
            "She'd rather follow Shellder's guidance\n"
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_WATER_STONE, SPECIES_SLOWBRO_MEGA}),
    },
    ...
    [SPECIES_SLOWKING] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "seems to increase her intelligence.\n"
    ...
    [SPECIES_SLOWBRO_MEGA] =
    {
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "Using the energy from Slowbro's Mega\n"
            "Evolution, Shellder was able to create\n"
            "impregnable armor for her. There is\n"
            "virtually no change in Slowbro."),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 296,
        .trainerOffset = 2,
    ...
    [SPECIES_SLOWPOKE_GALARIAN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Although very similar to her Kantonian\n"
            "sister, Galarian Slowpoke has become\n"
            "a little interested in fashion. Though,\n"
            "she's just as lazy in this field."),
    ...
    [SPECIES_SLOWBRO_GALARIAN] =
    {
        ...
        .weight = 705,
        .description = COMPOUND_STRING(
            "Galarian Slowbro has made further\n"
            "adjustments to her fashion style.\n"
            "Shellder has designed a new poison-point\n"
            "gauntlet to match her new color accents."),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 296,
        .trainerOffset = 2,
    ...
    [SPECIES_SLOWKING_GALARIAN] =
    {
        ...
        .description = COMPOUND_STRING(
            "In an attempt to help Slowking master\n"
            "her poison type abilities, Shellder\n"
            "gave her a crown that affects her mind.\n"
            "The crown seems to control her instead."),
    #endif
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
    ...
    [SPECIES_MAGNEMITE] =
    {
        ...
        .weight = 60,
        .description = COMPOUND_STRING(
            "Magnemite strongly embraces her friends.\n"
            "Once attached, it's a struggle\n"
            "to pull her off.\n"
            ""),
        .pokemonScale = 288,
        .pokemonOffset = -9,
    ...
    [SPECIES_MAGNETON] =
    {
        ...
        .weight = 600,
        .description = COMPOUND_STRING(
            "Magneton's bonds are said to be\n"
            "unbreakable. She is often seen guiding\n"
            "chains of Magnemite holding hands.\n"
            ""),
        .pokemonScale = 292,
        .pokemonOffset = 1,
        .trainerScale = 256,
    ...
    [SPECIES_MAGNEZONE] =
    {
        ...
        .weight = 1800,
        .description = COMPOUND_STRING(
            "Her strong bonds have led her to become\n"
            "an officer of the law. Her presence\n"
            "makes nearby Moémon feel safer.\n"
            ""),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
...
#define FARFETCHD_MISC_INFO                                 \
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .weight = 150,
        .description = COMPOUND_STRING(
            "Farfetch'd uses a leek as an improvised\n"
            "spear. Experts believe her choice of\n"
            "weapon is used to hold herself back.\n"
            ""),
        .pokemonScale = 330,
        .pokemonOffset = 2,
        .trainerScale = 293,
    ...
    [SPECIES_FARFETCHD_GALARIAN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "in the Galar region. Farfetch'd has adapted\n"
            "to these stalks, taking on a less agile but\n"
            "far harder hitting fighting style."),
        .pokemonScale = 330,
        .pokemonOffset = 2,
        .trainerScale = 293,
        .trainerOffset = 2,
    ...
    [SPECIES_SIRFETCHD] =
    {
        ...
        .weight = 1170,
        .description = COMPOUND_STRING(
            "Combining the fighting styles of both\n"
            "Farfetch'd sisters, they have attained\n"
            "a excellent and balanced form. Her Leek\n"
            "has been refined into a sword and shield."),
        .pokemonScale = 366,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_DODUO] =
    {
        ...
        .weight = 392,
        .description = COMPOUND_STRING(
            "Doduo values her hair piece as if it were\n"
            "a part of her. If lost, she will not stop\n"
            "wailing until it is found.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 257,
    ...
    [SPECIES_DODRIO] =
    {
        ...
        .weight = 852,
        .description = COMPOUND_STRING(
            "Though not the best in flight, she is a\n"
            "great runner. Dodrio has a preference for\n"
            "things in threes, as she can't count\n"
            "beyond that."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 268,
    ...
    [SPECIES_SEEL] =
    {
        ...
        .weight = 900,
        .description = COMPOUND_STRING(
            "Her long hair and cloak keep her warm.\n"
            "Seel can withstand water temperatures\n"
            "as low as fourteen below.\n"
            ""),
        .pokemonScale = 297,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_DEWGONG] =
    {
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "Dewgong spends all day hunting in icy\n"
            "waters. After filling up, she'll spend\n"
            "the rest of the day sunbathing.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 275,
...
#define KANTONIAN_GRIMER_FAMILY_INFO                                                \
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "Her hair is covered in a thick, toxic\n"
            "sort of goop. She can't control it, so\n"
            "it often forms a large puddle around her.\n"
            ""),
        .pokemonScale = 258,
        .pokemonOffset = 10,
        .trainerScale = 256,
    ...
    [SPECIES_MUK] =
    {
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "Having gained control over the toxic goop,\n"
            "she doesn't mind how it hinders movement,\n"
            "instead using it to improve her defenses.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 256,
...
#define ALOLAN_GRIMER_FAMILY_INFO                                                           \
    ...
    [SPECIES_SHELLDER] =
    {
        ...
        .weight = 40,
        .description = COMPOUND_STRING(
            "Shellder sticks her tongue out at anyone\n"
            "who passes. She think's it's\n"
            "intimidating, but many find it adorable.\n"
            ""),
        .pokemonScale = 675,
        .pokemonOffset = 24,
        .trainerScale = 256,
    ...
    [SPECIES_CLOYSTER] =
    {
        ...
        .weight = 1325,
        .description = COMPOUND_STRING(
            "She's extremely shy and hides her\n"
            "face under her hair. If she must, she'll\n"
            "unleash a barrage of icicles.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 269,
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .weight = 1,
        .description = COMPOUND_STRING(
            "Gastly loves to pull pranks on other\n"
            "Moémon. She gets lonely when her\n"
            "antics scare them off.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_HAUNTER] =
    {
        ...
        .weight = 1,
        .description = COMPOUND_STRING(
            "Haunter, like Gastly, enjoys playing\n"
            "pranks, but moreso for the sake\n"
            "of tormenting the other Moémon.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 293,
...
#define GENGAR_MISC_INFO                                            \
    ...
    [SPECIES_GENGAR] =
    {
        ...
        .weight = 405,
        .description = COMPOUND_STRING(
            "Gengar hides in people's shadows. When\n"
            "they least expect it, she pops out and\n"
            "scares them.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        ...
        PALETTES(Gengar),
        ICON(Gengar, 2),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_REAPER_CLOTH, SPECIES_GENGAR_MEGA}),
    },
    ...
    [SPECIES_GENGAR_MEGA] =
    {
        ...
        .weight = 405,
        .description = COMPOUND_STRING(
            "Gengar's relationships are warped. Her\n"
            "loneliness has begun to eat into her, so\n"
            "she has begun to user her abilities to\n"
            "capture those she wants to be with."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 302,
        .trainerOffset = 2,
    ...
    [SPECIES_ONIX] =
    {
        ...
        .weight = 2100,
        .description = COMPOUND_STRING(
            "Onix's braid grows an inch every few\n"
            "days. She is very methodical, sometimes\n"
            "taking weeks to make plans.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 515,
...
#define STEELIX_MISC_INFO                                       \
    ...
    [SPECIES_STEELIX] =
    {
        ...
        .weight = 4000,
        .description = COMPOUND_STRING(
            "As Onix became more battle hardened,\n"
            "she crafted a suit of armor to aid her in\n"
            "combat.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        ...
        PALETTES(Steelix),
        ICON(Steelix, 0),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DAWN_STONE, SPECIES_STEELIX_MEGA}),
    },
    ...
    [SPECIES_STEELIX_MEGA] =
    {
        ...
        .weight = 7400,
        .description = COMPOUND_STRING(
            "To further improve her defenses, Steelix\n"
            "took the energy from her Mega Evolution\n"
            "and forged it into crystal armor that can\n"
    ...
    [SPECIES_DROWZEE] =
    {
        ...
        .weight = 324,
        .description = COMPOUND_STRING(
            "Trainers suffering from night terrors\n"
            "allow Drowzee to eat their dreams so they\n"
    ...
    [SPECIES_HYPNO] =
    {
        ...
        .weight = 756,
        .description = COMPOUND_STRING(
            "Her pendulum and looks ensnare the\n"
            "hearts of young men. She lures them in\n"
            "to live with her in the forest.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 257,
    ...
    [SPECIES_KRABBY] =
    {
        ...
        .weight = 65,
        .description = COMPOUND_STRING(
            "Krabby loves to play in the sand.\n"
            "Long days in the sun have given her\n"
            "a rich tan.\n"
            ""),
        .pokemonScale = 469,
        .pokemonOffset = 20,
...
#define KINGLER_MISC_INFO                                                               \
    ...
    [SPECIES_KINGLER] =
    {
        ...
        .weight = 600,
        .description = COMPOUND_STRING(
            "She hoards parts of the beach to herself\n"
            "to perfect her tan. Her grip is said to\n"
            "bend steel, but leaves her exhausted.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 256,
    ...
    [SPECIES_KINGLER_GIGANTAMAX] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "spurred this Moémon's left pincer\n"
...
#define ELECTRODE_MISC_INFO                                     \
    ...
    [SPECIES_VOLTORB] =
    {
        ...
        .weight = 104,
        .description = COMPOUND_STRING(
            "The orb she's always seen with is used to\n"
            "generate static electricity. In battle,\n"
            "she rolls it towards opponents to\n"
            "shock them."),
    ...
    [SPECIES_ELECTRODE] =
    {
        ...
        .weight = 666,
        .description = COMPOUND_STRING(
            "She has an explosive temper. Electrode's\n"
            "battle strategy boils down to lobbing\n"
            "dynamite at anything that moves.\n"
            ""),
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .weight = 25,
        .description = COMPOUND_STRING(
            "Her eggs are her most precious\n"
            "possession. She sees them as an\n"
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_EXEGGUTOR] =
    {
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "Exeggutor draws energy from the sun. The\n"
            "more sunlight she gets, the taller she\n"
            "grows.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        ...
        ICON(Exeggutor, 1),
        LEARNSETS(Exeggutor),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_EXEGGUTOR_ALOLAN}),
    },
    ...
    [SPECIES_EXEGGUTOR_ALOLAN] =
    {
        ...
        .natDexNum = NATIONAL_DEX_EXEGGUTOR_ALOLAN,
        .height = 19,
        .weight = 4156,
        #if NSFW_CONTENT == TRUE
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "perform rituals celebrating family.\n"
            ""),
        .pokemonScale = 545,
        .pokemonOffset = 21,
        .trainerScale = 256,
...
#define MAROWAK_MISC_INFO                                       \
    ...
    [SPECIES_MAROWAK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "children. The bone she weilds is likely\n"
            "from a predator that treatened\n"
            "her family."),
    ...
    [SPECIES_MAROWAK_ALOLAN] =
    {
        ...
        .bodyColor = BODY_COLOR_PURPLE,
        .natDexNum = NATIONAL_DEX_MAROWAK_ALOLAN,
        .weight = 340,
        .description = COMPOUND_STRING(
            "The cursed flames that light up the bone\n"
            "carried by this Moémon are said\n"
    ...
    [SPECIES_TYROGUE] =
    {
        ...
        .weight = 210,
        .description = COMPOUND_STRING(
            "His natural fighting talent is held back\n"
            "by his lack of focus. He struggles to\n"
            "pick a fighting style to master.\n"
            ""),
        .pokemonScale = 292,
        .pokemonOffset = 9,
        .trainerScale = 256,
    ...
    [SPECIES_HITMONLEE] =
    {
        ...
        .weight = 498,
        .description = COMPOUND_STRING(
            "Hitmonlee is a naturally skilled\n"
            "kickboxer. Even humans look to him\n"
            "for training.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 3,
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        .weight = 502,
        .description = COMPOUND_STRING(
            "Hitmonchan is a skilled boxer with an\n"
            "unbreakably strong resolve and will.\n"
            "He is a master of slipping and blocking.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 277,
    ...
    [SPECIES_HITMONTOP] =
    {
        ...
        .weight = 480,
        .description = COMPOUND_STRING(
            "In an effort to balance attack and \n"
            "defense, Hitmontop has mastered the\n"
            "style of capoeira.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 2,
    ...
    [SPECIES_LICKITUNG] =
    {
        ...
        .weight = 655,
        .description = COMPOUND_STRING(
            "Lickitung identifies things by licking\n"
            "them. Male Trainers love raising her\n"
            "to see them interact with other women.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_LICKILICKY] =
    {
        ...
        .weight = 1400,
        .description = COMPOUND_STRING(
            "Her tongue has become even longer and\n"
            "more powerful. Though due to chemical\n"
            "changes in her saliva, she numbs those\n"
            "she licks now."),
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 290,
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .weight = 10,
        .description = COMPOUND_STRING(
            "She loves pirate roleplay, and frequently\n"
            "loots the stashes of other Moémon.\n"
            "If caught, she escapes in a puff of smoke.\n"
            ""),
        .pokemonScale = 369,
        .pokemonOffset = -1,
        .trainerScale = 256,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_WEEZING},
                                {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_WEEZING_GALARIAN}),
    },
...
#define WEEZING_MISC_INFO                                           \
    ...
    [SPECIES_WEEZING] =
    {
        ...
        .weight = 95,
        .description = COMPOUND_STRING(
            "Weezing leads a crew of Koffing pirates.\n"
            "Her experience and leadership result in\n"
            "greater success for Koffing under her.\n"
            "Their greatest rivals are Sharpedo crews."),
        .pokemonScale = 305,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WEEZING_GALARIAN] =
    {
        ...
        .bodyColor = BODY_COLOR_GRAY,
        .isGalarianForm = TRUE,
        .natDexNum = NATIONAL_DEX_WEEZING_GALARIAN,
        .height = 18,
        .weight = 160,
        .description = COMPOUND_STRING(
            "A former leader of a Weezing pirate gang,\n"
            "she has retired from that line of work and\n"
            "is applying her leadership experience in\n"
            "the corporate world."),
        .pokemonScale = 305,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_RHYHORN] =
    {
        ...
        .weight = 1150,
        .description = COMPOUND_STRING(
            "Rhyhorn lives for battle and will charge\n"
            "into fights blindly. She uses her head more\n"
            "than she uses her brain.\n"
            ""),
        .pokemonScale = 267,
        .pokemonOffset = 6,
        .trainerScale = 256,
    ...
    [SPECIES_RHYDON] =
    {
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "Her signature strategy is charging in\n"
            "drill first. Luckily for her, her drill\n"
            "can pierce any armor.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 299,
    ...
    [SPECIES_RHYPERIOR] =
    {
        ...
        .weight = 2828,
        .description = COMPOUND_STRING(
            "Her armor has become so heavy that\n"
            "she struggles to chase down enemies\n"
            "outside the range of her drill. She\n"
            "has chosen to equip a shield-gun to help."),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 369,
        .trainerOffset = 7,
    ...
    [SPECIES_HAPPINY] =
    {
        ...
        .weight = 244,
        .description = COMPOUND_STRING(
            "Happiny collects a rare, round white rock\n"
            "She will gift one to those she really\n"
            "likes to play with.\n"
            ""),
        .pokemonScale = 422,
        .pokemonOffset = 15,
    ...
    [SPECIES_CHANSEY] =
    {
        ...
        .weight = 346,
        .description = COMPOUND_STRING(
            "A caring healer, Chansey lingers after\n"
            "battles to help injured Moémon\n"
    ...
    [SPECIES_BLISSEY] =
    {
        ...
        .weight = 468,
        .description = COMPOUND_STRING(
            "This rare Moémon is a compassionate\n"
            "and talented healer. The egg she carries\n"
            "with her can cure small ailments.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 310,
    ...
    [SPECIES_TANGELA] =
    {
        ...
        .weight = 350,
        .description = COMPOUND_STRING(
            "Tangela's messy hair isn't just for\n"
            "wrapping up prey, but serves as a\n"
            "disguise while hiding in bushes.\n"
            ""),
        .pokemonScale = 304,
        .pokemonOffset = 1,
        .trainerScale = 256,
    ...
    [SPECIES_TANGROWTH] =
    {
        ...
        .weight = 1286,
        .description = COMPOUND_STRING(
            "Tangrowth ensnares others by extending her\n"
            "incredibly strong hair. She has also become\n"
            "capable of growing more of her hair on demand.\n"
            ""),
        .pokemonScale = 261,
        .pokemonOffset = 1,
        .trainerScale = 334,
...
#define KANGASKHAN_MISC_INFO                                    \
    ...
    [SPECIES_KANGASKHAN] =
    {
        ...
        .weight = 800,
        .description = COMPOUND_STRING(
            "Kangaskhan's motherly instincts make\n"
            "her a fierce protector- and even fiercer\n"
            "enemy.\n"
            ""),
        ...
        PALETTES(Kangaskhan),
        ICON(Kangaskhan, 2),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_EVERSTONE, SPECIES_KANGASKHAN_MEGA}),
    },
    ...
    [SPECIES_KANGASKHAN_MEGA] =
    {
        ...
        .weight = 1000,
        .description = COMPOUND_STRING(
            "When Kangaskhan sees the back of her\n"
    ...
    [SPECIES_HORSEA] =
    {
        ...
        .weight = 80,
        .description = COMPOUND_STRING(
            "Horsea wants to grow up to be a dragon.\n"
            "She follows Dragon-type Moémon around,\n"
            "but is too shy to approach them.\n"
            ""),
        .pokemonScale = 399,
        .pokemonOffset = -1,
        .trainerScale = 256,
    ...
    [SPECIES_SEADRA] =
    {
        ...
        .weight = 250,
        .description = COMPOUND_STRING(
            "Seadra is very rooted in the traditions\n"
            "of her family. She collects Dragon Scales\n"
            "to make jewelry and accessories.\n"
            ""),
        .pokemonScale = 299,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_KINGDRA] =
    {
        ...
        .weight = 1520,
        .description = COMPOUND_STRING(
            "The Dragon Scales she spent years\n"
            "gathering have been fashioned into a\n"
            "lovely fan. Few challenge her rule.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 287,
    ...
    [SPECIES_GOLDEEN] =
    {
        ...
        .weight = 150,
        .description = COMPOUND_STRING(
            "Her graceful swimming causes onlookers\n"
            "to refer to her as Princess of the Sea.\n"
            "\n"
            ""),
        .pokemonScale = 379,
        .pokemonOffset = 4,
    ...
    [SPECIES_SEAKING] =
    {
        ...
        .weight = 390,
        .description = COMPOUND_STRING(
            "Despite being female, she has earned the\n"
            "respect of all water Moémon. This has\n"
            "earned her the title of King of the Sea.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_STARYU] =
    {
        ...
        .weight = 345,
        .description = COMPOUND_STRING(
            "The blinking light on her torso is her\n"
            "way of communicating. It also gives\n"
            "her strange restorative powers.\n"
            ""),
        .pokemonScale = 326,
        .pokemonOffset = 1,
        .trainerScale = 256,
    ...
    [SPECIES_STARMIE] =
    {
        ...
        .weight = 800,
        .description = COMPOUND_STRING(
            "The light on her core can light up in\n"
            "any color. Scientists believe Starmie is\n"
            "transmitting messages to the stars.\n"
            ""),
        .pokemonScale = 301,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .weight = 130,
        .description = COMPOUND_STRING(
            "Although she's quite the klutz,\n"
            "Mime Jr. tries her best to become\n"
            "as skilled as her older sisters.\n"
            ""),
        .pokemonScale = 422,
        .pokemonOffset = 14,
        .trainerScale = 256,
...
#define MR_MIME_MISC_INFO                                           \
    ...
    [SPECIES_MR_MIME] =
    {
        ...
        .weight = 545,
        .description = COMPOUND_STRING(
            "Nothing makes Ms. Mime happier than\n"
            "entertaining others. She holds impromptu\n"
            "shows just for the fun of it.\n"
            ""),
        .pokemonScale = 258,
        .pokemonOffset = 6,
        .trainerScale = 256,
    ...
    [SPECIES_MR_MIME_GALARIAN] =
    {
        ...
        .bodyColor = BODY_COLOR_WHITE,
        .natDexNum = NATIONAL_DEX_MR_MIME_GALARIAN,
        ...
        .description = COMPOUND_STRING(
            ...
            "Moémon can kick up to use as a barrier."),
        .pokemonScale = 258,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .weight = 560,
        .description = COMPOUND_STRING(
            "Scyther's speed and silence often get\n"
            "her mistaken for a ninja. She leaves\n"
            "a trail of felled trees in her wake.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 293,
...
#define SCIZOR_MISC_INFO                                \
    ...
    [SPECIES_SCIZOR] =
    {
        ...
        .weight = 1180,
        .description = COMPOUND_STRING(
            "Trading speed for defense, Scizor gets in\n"
            "close, deflecting hits with well-timed\n"
            "parries before unleashing heavy strikes.\n"
            ""),
        .pokemonScale = 278,
        .pokemonOffset = 1,
        .trainerScale = 256,
        ...
        PALETTES(Scizor),
        ICON(Scizor, 0),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR_MEGA}),
    },
    ...
    [SPECIES_SCIZOR_MEGA] =
    {
        ...
        .weight = 1250,
        .description = COMPOUND_STRING(
            "Using the power of Mega Evolution energy,\n"
            "Scizor has pushed past her limits. She\n"
            "is even faster despite her heavy armor,\n"
            "though the energy makes her body hot."),
        .pokemonScale = 278,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KLEAVOR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "stone. Should one encounter this Moémon\n"
    ...
    [SPECIES_SMOOCHUM] =
    {
        ...
        .weight = 60,
        .description = COMPOUND_STRING(
            "A very affectionate Moémon, Smoochum\n"
            "loves to plant kisses on her Trainer. She\n"
            "tries to imitate Jynx's style.\n"
            ""),
        .pokemonScale = 440,
        .pokemonOffset = 20,
        .trainerScale = 256,
    ...
    [SPECIES_JYNX] =
    {
        ...
        .weight = 406,
        .description = COMPOUND_STRING(
            "Jynx loves to stay on top of trends.\n"
            "Magazines love to feature her as a model.\n"
            "\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 3,
    ...
    [SPECIES_ELEKID] =
    {
        ...
        .weight = 235,
        .description = COMPOUND_STRING(
            "Each of her horns has an opposing charge.\n"
            "Completing the circuit can power a house\n"
            "for days... or cause a blackout.\n"
            ""),
        .pokemonScale = 363,
        .pokemonOffset = 14,
        .trainerScale = 256,
    ...
    [SPECIES_ELECTABUZZ] =
    {
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "Electabuzz is the bane of electric\n"
            "companies, as she feeds by syphoning\n"
            "1000s of watts from their transformers.\n"
            ""),
        .pokemonScale = 351,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_ELECTIVIRE] =
    {
        ...
        .weight = 1386,
        .description = COMPOUND_STRING(
            "Electivire has mastered electricity,\n"
            "able to throw incredibly powerful\n"
            "lightning bolts. She wears special\n"
            "clothing to help contain her vast energy."),
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [SPECIES_MAGBY] =
    {
        ...
        .weight = 214,
        .description = COMPOUND_STRING(
            "Warmth radiates from Magby, even while\n"
            "still in its egg. It's popular with\n"
            "breeders for use in incubation.\n"
            ""),
        .pokemonScale = 284,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    [SPECIES_MAGMAR] =
    {
        ...
        .weight = 445,
        .description = COMPOUND_STRING(
            "Her temper runs short, but oddly, she\n"
            "takes great joy in helping other Moémon\n"
            "incubate their eggs with her body heat.\n"
            ""),
        .pokemonScale = 277,
        .pokemonOffset = 5,
        .trainerScale = 256,
    ...
    [SPECIES_MAGMORTAR] =
    {
        ...
        .weight = 680,
        .description = COMPOUND_STRING(
            "While helping incubate eggs, she has\n"
            "also mastered her fire abilities.\n"
            "She is capable of gently warming eggs\n"
            "while also launching fireballs."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
...
#define PINSIR_MISC_INFO                                \
    ...
    [SPECIES_PINSIR] =
    {
        ...
        .weight = 550,
        .description = COMPOUND_STRING(
            "Pinsir's brutal spear jabs can fell even\n"
            "the toughest bugs. She has a long-\n"
            "-standing feud with Heracross.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 257,
        ...
        PALETTES(Pinsir),
        ICON(Pinsir, 2),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SILVER_POWDER, SPECIES_PINSIR_MEGA}),
    },
    ...
    [SPECIES_PINSIR_MEGA] =
    {
        ...
        .weight = 590,
        .description = COMPOUND_STRING(
            "She thought that Mega Evolution would\n"
            "lead to her outclassing Heracross, but\n"
            "Heracross mastered it alongside her.\n"
            "Their sparring matches are incredible."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 257,
        .trainerOffset = 0,
...
#define TAUROS_MISC_INFO                                    \
    ...
    [SPECIES_TAUROS] =
    {
        ...
        .weight = 884,
        .description = COMPOUND_STRING(
            "When enraged, Tauros can be near\n"
            "impossible to stop. Whole herds of Tauros\n"
            "can fight for days over a single Miltank.\n"
            ""),
    ...
    [SPECIES_TAUROS_PALDEAN_COMBAT_BREED] =
    {
        ...
        .bodyColor = BODY_COLOR_BROWN,
        .natDexNum = NATIONAL_DEX_TAUROS_COMBAT,
        .weight = 1150,
        .description = COMPOUND_STRING(
            "This Moémon has a muscular body\n"
            "and excels at close-quarters combat.\n"
            "Her uses her short horns to strike\n"
    ...
    [SPECIES_TAUROS_PALDEAN_BLAZE_BREED] =
    {
        ...
        .abilities = { ABILITY_INTIMIDATE, ABILITY_ANGER_POINT, ABILITY_CUD_CHEW },
        .bodyColor = BODY_COLOR_BROWN,
        .natDexNum = NATIONAL_DEX_TAUROS_BLAZE,
        .weight = 850,
        .description = COMPOUND_STRING(
            "When heated by fire energy, her horns can\n"
            "get hotter than 1,800 degrees Fahrenheit.\n"
            "Those attacked by them will suffer\n"
    ...
    [SPECIES_TAUROS_PALDEAN_AQUA_BREED] =
    {
        ...
        .abilities = { ABILITY_INTIMIDATE, ABILITY_ANGER_POINT, ABILITY_CUD_CHEW },
        .bodyColor = BODY_COLOR_BROWN,
        .natDexNum = NATIONAL_DEX_TAUROS_AQUA,
        .weight = 1100,
        .description = COMPOUND_STRING(
            "This Moémon blasts water from holes on\n"
            "the tips of her horns--the high-pressure\n"
            "jets pierce right through the defenses of\n"
            "Tauros’s enemies."),
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .weight = 100,
        .description = COMPOUND_STRING(
            "Magikarp can often be found splashing\n"
            "around in any body of water. She's very\n"
...
#define GYARADOS_MISC_INFO                                  \
    ...
    [SPECIES_GYARADOS] =
    {
        ...
        .weight = 2350,
        .description = COMPOUND_STRING(
            "Once a Magikarp, Gyarados managed\n"
            "to swim up a waterfall. Her new look is\n"
            "intimidating, but she is still cheery.\n"
            ""),
        ...
        PALETTES(Gyarados),
        ICON(Gyarados, 0),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_BERSERK_GENE, SPECIES_GYARADOS_MEGA}),
    },
    ...
    [SPECIES_GYARADOS_MEGA] =
    {
        ...
        .weight = 3050,
        .description = COMPOUND_STRING(
            "Gyarados has become even more powerful,\n"
            "donning the traditional clothes of her\n"
            "ancestors. While embracing a new warrior\n"
            "code, she still has a soft personality."),
...
#define LAPRAS_MISC_INFO                                                                \
    ...
    [SPECIES_LAPRAS] =
    {
        ...
        .weight = 2200,
        .description = COMPOUND_STRING(
            "Her soothing, gentle songs roll across\n"
            "the ocean like waves. She often helps\n"
            "Trainers cross large bodies of water.\n"
            ""),
        .pokemonScale = 257,
        .pokemonOffset = 10,
        .trainerScale = 423,
    ...
    [SPECIES_DITTO] =
    {
        ...
        .weight = 40,
        .description = COMPOUND_STRING(
            "Ditto carries a backpack full of masks.\n"
            "She loves to imitate Moémon she sees,\n"
            "and can even copy their abilities.\n"
            ""),
        .pokemonScale = 633,
        .pokemonOffset = 23,
        .trainerScale = 256,
...
#define EEVEE_MISC_INFO                                                                 \
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .weight = 65,
        .description = COMPOUND_STRING(
            "Eevee has great potential, but she hasn't\n"
            "decided what she wants to do when\n"
            "she grows up.\n"
            ""),
        .pokemonScale = 476,
        .pokemonOffset = 18,
    ...
    [SPECIES_VAPOREON] =
    {
        ...
        .weight = 290,
        .description = COMPOUND_STRING(
            "Vaporeon is very relaxed and calm, but\n"
            "seems to melt away when scared. She\n"
            "can often be found sleeping near lakes.\n"
            ""),
        .pokemonScale = 316,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .weight = 245,
        .description = COMPOUND_STRING(
            "She overflows with energy, and very\n"
            "few Moémon can keep up with her.\n"
            "Her attitude can cause some friction.\n"
            ""),
        .pokemonScale = 283,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .weight = 250,
        .description = COMPOUND_STRING(
            "Her fiery spirit energizes others and\n"
            "drives them to work her best. Flareon's\n"
            "warmth makes her a great cuddler.\n"
            ""),
        .pokemonScale = 306,
        .pokemonOffset = 12,
        .trainerScale = 256,
    ...
    [SPECIES_ESPEON] =
    {
        ...
        .weight = 265,
        .description = COMPOUND_STRING(
            "Espeon's tail twitches to indicate her\n"
            "foe's battle strategies. While calm in\n"
            "battle, she's often a ray of sunshine.\n"
            ""),
        .pokemonScale = 363,
        .pokemonOffset = 14,
        .trainerScale = 256,
    ...
    [SPECIES_UMBREON] =
    {
        ...
        .weight = 270,
        .description = COMPOUND_STRING(
            "Cunning and mischievous, Umbreon\n"
            "loves to pull pranks and tease. She seems\n"
    ...
    [SPECIES_LEAFEON] =
    {
        ...
        .weight = 255,
        .description = COMPOUND_STRING(
            "The leaves she finds while foraging are\n"
            "used for a variety of medicinal\n"
            "purposes.\n"
            ""),
        .pokemonScale = 305,
        .pokemonOffset = 8,
    ...
    [SPECIES_GLACEON] =
    {
        ...
        .weight = 259,
        .description = COMPOUND_STRING(
            "Glaceon's figure skating skills impress\n"
            "people all over the world. Her cold\n"
            "demeanor melts away when she skates.\n"
            ""),
        .pokemonScale = 366,
        .pokemonOffset = 10,
        .trainerScale = 257,
    ...
    [SPECIES_SYLVEON] =
    {
        ...
        .weight = 235,
        .description = COMPOUND_STRING(
            "Her ribbons accentuate her graceful yet\n"
            "quick dancing style. Some say she can\n"
            "use them in combat to hypnotize her\n"
            "enemies."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
    ...
    [SPECIES_PORYGON] =
    {
        ...
        .weight = 365,
        .description = COMPOUND_STRING(
            "Porygon serves as a digital assistant\n"
            "to many PC users. She takes great joy in\n"
            "helping others.\n"
            ""),
        .pokemonScale = 328,
        .pokemonOffset = 15,
    ...
    [SPECIES_PORYGON2] =
    {
        ...
        .weight = 325,
        .description = COMPOUND_STRING(
            "The first official update to Porygon, \n"
            "Porygon2 is planned to aid in space\n"
            "travel when technology catches up.\n"
            ""),
        .pokemonScale = 320,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_PORYGON_Z] =
    {
        ...
        .weight = 340,
        .description = COMPOUND_STRING(
            "A bootleg update was installed on her to\n"
            "make her even more useful, but it seems\n"
            "to have made her lose control.\n"
            ""),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_OMANYTE] =
    {
        ...
        .weight = 75,
        .description = COMPOUND_STRING(
            "Omanyte used to be very common in\n"
            "the seas. She feels out of place in the\n"
            "modern world, but Kabuto helps.\n"
            ""),
        .pokemonScale = 521,
        .pokemonOffset = 22,
        .trainerScale = 256,
    ...
    [SPECIES_OMASTAR] =
    {
        ...
        .weight = 350,
        .description = COMPOUND_STRING(
            "Her bite can crack even the toughest of\n"
            "shells. She spends a little too much time\n"
    ...
    [SPECIES_KABUTO] =
    {
        ...
        .weight = 115,
        .description = COMPOUND_STRING(
            "The top of Kabuto's head is as hard as a\n"
            "rock. She sleeps in caves and never\n"
            "notices when stalactites fall on her.\n"
            ""),
        .pokemonScale = 454,
        .pokemonOffset = 21,
        .trainerScale = 256,
    ...
    [SPECIES_KABUTOPS] =
    {
        ...
        .weight = 405,
        .description = COMPOUND_STRING(
            "Her scythe can clear out a dozen opposing\n"
            "Moémon in a single swing. She's still a\n"
            "little disoriented from her long slumber.\n"
            ""),
        .pokemonScale = 271,
        .pokemonOffset = 3,
        .trainerScale = 256,
...
#define AERODACTYL_MISC_INFO                                \
    ...
    [SPECIES_AERODACTYL] =
    {
        ...
        .weight = 590,
        .description = COMPOUND_STRING(
            "In times long past, Aerodactyl was queen\n"
            "of the skies. Her ferocious fangs hide\n"
            "the fact that she loves headpats.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 302,
        ...
        PALETTES(Aerodactyl),
        ICON(Aerodactyl, 2),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_HARD_STONE, SPECIES_AERODACTYL_MEGA}),
    },
    ...
    [SPECIES_AERODACTYL_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "completely restored her former power.\n"
            "She spars with Archeops to satisfy her"
            "primal desire to battle."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 302,
        .trainerOffset = 4,
    ...
    [SPECIES_MUNCHLAX] =
    {
        ...
        .weight = 1050,
        .description = COMPOUND_STRING(
            "Munchlax collects many Berries and keeps\n"
            "them in a bag for when she hibernates,\n"
            "but it gets a bit too heavy to carry.\n"
            ""),
        .pokemonScale = 422,
        .pokemonOffset = 14,
        .trainerScale = 256,
...
#define SNORLAX_MISC_INFO                                                       \
    ...
    [SPECIES_SNORLAX] =
    {
        ...
        .weight = 4600,
        .description = COMPOUND_STRING(
            "The only thing Snorlax loves more than\n"
            "eating is napping. Sometimes she'll do\n"
...
#define ARTICUNO_MISC_INFO                                              \
    ...
    [SPECIES_ARTICUNO] =
    {
        ...
        .categoryName = _("Arctic Wind"),
        .weight = 554,
        .description = COMPOUND_STRING(
            "Articuno's cold personality clashes\n"
            "with those of her sisters. A strong flap\n"
            "of her wings can cause a blizzard.\n"
            "when this Moémon flies, snow will fall."),
    ...
    [SPECIES_ARTICUNO_GALARIAN] =
    {
        ...
        .bodyColor = BODY_COLOR_PURPLE,
        .natDexNum = NATIONAL_DEX_ARTICUNO_GALARIAN,
        .categoryName = _("Cruel"),
        .weight = 509,
        .description = COMPOUND_STRING(
            "She fires beams that immobilize opponents\n"
            "as if they had been frozen solid.\n"
            "Her feather-like blades of psychic energy\n"
...
#define ZAPDOS_MISC_INFO                                                \
    ...
    [SPECIES_ZAPDOS] =
    {
        ...
        .categoryName = _("Thunderbird"),
        .weight = 526,
        .description = COMPOUND_STRING(
            "Zapdos is watchful and protective of\n"
            "her sisters. She's often stoic but loves\n"
            "playing in the rain.\n"
            ""),
    ...
    [SPECIES_ZAPDOS_GALARIAN] =
    {
        ...
        .natDexNum = NATIONAL_DEX_ZAPDOS_GALARIAN,
        .categoryName = _("Strong Legs"),
        .weight = 582,
        .description = COMPOUND_STRING(
            "When her feathers rub together, they\n"
            "produce a crackling sound like the\n"
            "zapping of electricity. Apparently, she can\n"
            "run through the mountains at over 180 mph."),
...
#define MOLTRES_MISC_INFO                                               \
    ...
    [SPECIES_MOLTRES] =
    {
        ...
        .categoryName = _("Firebird"),
        .weight = 600,
        .description = COMPOUND_STRING(
            "Moltres can be a hothead, but is very\n"
            "defensive of her sisters. Her appearance\n"
            "is said to bring an early spring.\n"
            ""),
    ...
    [SPECIES_MOLTRES_GALARIAN] =
    {
        ...
        .bodyColor = BODY_COLOR_RED,
        .natDexNum = NATIONAL_DEX_MOLTRES_GALARIAN,
        .categoryName = _("Malevolent"),
        .weight = 660,
        .description = COMPOUND_STRING(
            "Moltres' sinister, flame-like aura\n"
    ...
    [SPECIES_DRATINI] =
    {
        ...
        .weight = 33,
        .description = COMPOUND_STRING(
            "Dratini is fearful of the world and would\n"
            "rather live a quiet life near a river.\n"
            "Her potential is greater than she knows.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 8,
        .trainerScale = 386,
    ...
    [SPECIES_DRAGONAIR] =
    {
        ...
        .weight = 165,
        .description = COMPOUND_STRING(
            "Dragonair's pendant has a mysterious\n"
            "power over the weather. Age has made\n"
            "her slightly more bold.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 411,
    ...
    [SPECIES_DRAGONITE] =
    {
        ...
        .weight = 2100,
        .description = COMPOUND_STRING(
            "Despite her incredible power, she still\n"
            "likes her simple life and is extremely\n"
            "gentle.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
...
#define SPECIES_MEWTWO_MISC_INFO                                        \
    ...
    [SPECIES_MEWTWO] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Her great power can't wash away her\n"
            "questions about her existence.\n"
            ""),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
        ...
        PALETTES(Mewtwo),
        ICON(Mewtwo, 2),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_BERSERK_GENE, SPECIES_MEWTWO_MEGA_X},
                                {EVO_ITEM, ITEM_TWISTED_SPOON, SPECIES_MEWTWO_MEGA_Y}),
    },
    ...
    [SPECIES_MEW] =
    {
        ...
        .weight = 40,
        .description = COMPOUND_STRING(
            "She's very shy and elusive. Most Moémon\n"
            "can be tied to Mew through DNA. Some\n"
            "speculate she might be the first Moémon.\n"
            ""),
        .pokemonScale = 457,
        .pokemonOffset = -2,
        .trainerScale = 256,
